...
export default function AuthPage() {
  ...
  const validEmail = 'admin@agentx.com'
  const validPassword = 'AgentX@123'
  ...
  const validateForm = () => {
    ...
    if (!sanitizedEmail) newErrors.push('Email is required')
    else if (!isValidEmail(sanitizedEmail)) newErrors.push('Please enter a valid email address')

    if (!sanitizedPassword) newErrors.push('Password is required')
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (sanitizedEmail === validEmail && sanitizedPassword === validPassword) {
      showAlert('Success', 'You are now signed in.', 'success')
      setTimeout(() => {
        closeAlert()
    ...
    <div className="min-h-screen bg-black flex items-center justify-center px-4">
      <div className="w-full max-w-lg">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <Input
                  ...
                  required
                  className="w-full px-4 py-3 bg-neutral-800 border border-neutral-700 rounded-xl text-white placeholder-gray-400"
                />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <Input
                    ...
                    onChange={handleInputChange}
                    required
                    className="w-full px-4 py-3 pr-12 bg-neutral-800 border border-neutral-700 rounded-xl text-white placeholder-gray-400"
                  />
              ...
              <Button type="submit" disabled={isLoading} className="w-full py-4 text-lg font-bold text-black rounded-xl disabled:opacity-50" style={{ backgroundColor: 'oklch(76.8% 0.233 130.85)' }}>
        ...
        <div className="mt-8 text-center text-gray-500 text-sm">
          <p>
            Use <code>{validEmail}</code> / <code>{validPassword}</code> to log in.
          </p>
        </div>
      </div>
      ...
      <Dialog open={alertDialog.isOpen} onOpenChange={closeAlert}>
        <DialogContent className="bg-neutral-900 border-neutral-800 text-white">
          ...
          <div className="flex justify-end mt-4">
            <Button onClick={closeAlert} className="px-6 py-2 text-black font-semibold rounded-lg" style={{ backgroundColor: 'oklch(76.8% 0.233 130.85)' }}>
              OK
            </Button>
          </div>
        </DialogContent>
